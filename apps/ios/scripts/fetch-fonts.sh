#!/usr/bin/env bash
# Downloads the Rajdhani brand fonts into AlgoMinutes/Resources/Fonts/ and verifies
...
for w in ("Medium", "SemiBold", "Bold"):
    path = f"AlgoMinutes/Resources/Fonts/Rajdhani-{w}.ttf"

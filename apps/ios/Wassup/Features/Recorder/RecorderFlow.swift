    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            case .ready:
                ...
                Text("Wassup Doc records audio from this device for as long as you're recording. Afterwards it's transcribed and summarised for you. You can stop at any time.")
            ...
            case .consent:
                ...
                if !consentShownBefore {
                    Text("Wassup Doc records audio from this device for as long as you're recording. The audio is uploaded to be transcribed and summarised, then kept in your account until you delete it.")
                        .font(Typography.body(15))
                        .foregroundStyle(Theme.body)
                        .fixedSize(horizontal: false, vertical: true)
                }

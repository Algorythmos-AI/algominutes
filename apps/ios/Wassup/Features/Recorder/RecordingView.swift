...
struct RecordingView: View {
    ...
    ///
    /// The old version read "298s left — Wassup auto-stops at 120:00": raw
    /// seconds counting down and a timer-formatted cap. Mid-consult a
    /// clinician should not have to convert either.
    ...
    var body: some View {
        ...
        .onChange(of: env.recorder.recordingError) { _, error in
            ...
            // unconditionally, so a clinician 55 minutes into a consult lost
    ...
    private func upload(_ result: RecorderService.StopResult, title: String) {
        ...
        // dismissing first opened a window where the doctor was offered

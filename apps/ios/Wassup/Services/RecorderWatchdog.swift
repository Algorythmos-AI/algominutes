...
/// forever while the screen still read "Recording in progress". The doctor
/// finished a consultation believing it was captured. Nothing detected it,
...
enum RecorderWatchdog {
    ...
    /// Tell the doctor early. This is the whole point: while diverged, nothing
    /// is being captured, and every second they don't know is a second of
    /// consultation they think is recorded and isn't.
    ...
    /// stop buys is forcing the consult into two notes when the call ends. Five
